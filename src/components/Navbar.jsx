...
const Navbar = () => {
  ...
  const [isSearchExpanded, setIsSearchExpanded] = useState(false); // For mobile view
  ...
  return (
    ...
    >
      <div className="navbar mt-2">
        ...
        <div className="navbar-center flex-grow mx-4">
          <div className="relative w-full max-w-lg">
            <div className="flex items-center">
              ...
              <input
                ...
                className={`input input-bordered w-full rounded-full px-4 py-2 transition-all duration-300 ${
            ...
            <div className="relative">
              ...
              >
                <img
                  ...
                  alt="Profile"
                  className="mt-2 w-11 h-11 rounded-full border-2 border-white object-cover"
                />
              </button>
              {dropdownOpen && (
